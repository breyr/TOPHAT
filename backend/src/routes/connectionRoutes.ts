...
router.post('/create/bulk', authenticateToken, async (req: AuthenticatedRequest, res, next) => connectionController.createConnectionBulk(req, res, next));
...
router.put('/update/bulk', authenticateToken, async (req: AuthenticatedRequest, res, next) => connectionController.updateConnectionBulk(req, res, next));
...
router.delete('/delete/bulk', authenticateToken, async (req: AuthenticatedRequest, res, next) => connectionController.deleteConnectionBulk(req, res, next));
