    ...
    return (
        <div className="flex-grow w-full">
            <Accordion allowMultiple transition transitionTimeout={200}>
                <AccordionItem header={<div className="flex flex-row items-center gap-2 my-1"><RouterIcon className="mr-2 size-8" /> <span className="text-xl">Routers</span></div>}>
                    <DragAndDropContainer devices={routers} />
                </AccordionItem>
                <AccordionItem header={<div className="flex flex-row items-center gap-2 my-1"><SwitchIcon className="mr-2 size-8" /> <span className="text-xl">Switches</span></div>}>
                    <DragAndDropContainer devices={switches} />
                </AccordionItem>
                <AccordionItem header={<div className="flex flex-row items-center gap-2 my-1"><ExternalIcon className="mr-2 size-8" /> <span className="text-xl">External</span></div>}>
                    <DragAndDropContainer devices={externalDevices} />
                </AccordionItem>
                <AccordionItem header={<div className="flex flex-row items-center gap-2 my-1"><ServerIcon className="mr-2 size-8" /> <span className="text-xl">Servers</span></div>}>
