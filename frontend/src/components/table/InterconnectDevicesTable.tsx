...
export default function InterconnectDevicesTable({
    ...
    const columns = [
        ...
        },
        {
            name: 'IP Address',
            sortable: true,
            cell: (row: Device) => renderCell(row, 'ipAddress', 'IP Address')
        },
        {
            name: 'Username',
            sortable: true,
            cell: (row: Device) => renderCell(row, 'username', 'Username')
        },
        {
            name: 'Password',
            sortable: true,
            cell: (row: Device) => renderCell(row, 'password', 'Password')
        },
        {
            name: 'Secret Password',
            sortable: true,
            cell: (row: Device) => renderCell(row, 'secretPassword', 'Secret Password')
        },
        {
            name: 'Ports',
            cell: (row: Device) => (
